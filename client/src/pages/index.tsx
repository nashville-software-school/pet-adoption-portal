  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Find your perfect pet companion at our adoption portal" />
      </Head>
      ...
      <div className="home-page">
        <div className="jumbotron bg-light p-5 rounded mb-4">
          ...
          <Link href="/pets" className="btn btn-primary btn-lg">
            Browse Pets
          </Link>
        </div>
          ...
          <div className="col-md-4">
            <div className="card mb-4">
              <div className="card-body">
                ...
                <Link href="/pets" className="btn btn-outline-primary">Browse Pets</Link>
              </div>
            </div>
          </div>
          <div className="col-md-4">
            <div className="card mb-4">
              <div className="card-body">
                ...
                <Link href="/add-pet" className="btn btn-outline-primary">Add a Pet</Link>
              </div>
            </div>
          </div>
          <div className="col-md-4">
